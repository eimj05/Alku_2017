...
<div class="container">
    ...
    <h1>Diplomados
        <a href="{{ url('diplomado1/diplomados1/' . $diplomados1->id . '/edit') }}" class="btn btn-primary btn-xs" title="Editar Diplomado"><span class="glyphicon glyphicon-pencil" aria-hidden="true"/></a>
        {!! Form::open([
            'method'=>'DELETE',
