            ...
            @foreach($diplomados1 as $item)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ url('/Fdiplomadosdetalle/' . $item->id) }}" target="blank" class="btn btn-primary btn-xs" title="Ver frontend"><span class="glyphicon glyphicon-new-window" aria-hidden="true"/></a>
