...
<div class="container">
    ...
    {!! Form::open(['url' => '/empresa1/empresa1', 'class' => 'form-horizontal']) !!}

                <div class="form-group {{ $errors->has('nombreEmpresa') ? 'has-error' : ''}}">
                {!! Form::label('nombreEmpresa', 'Nombre', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
            ...
            <div class="form-group {{ $errors->has('fechaRegistro') ? 'has-error' : ''}}">
                {!! Form::label('fechaRegistro', 'Fecha de Registro', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
            ...
            <div class="form-group {{ $errors->has('idRol_fk') ? 'has-error' : ''}}">
                {!! Form::label('idRol_fk', 'Rol', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
