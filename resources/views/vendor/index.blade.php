...
<div class="container">
    ...
    <h1>Ubicaciones<a href="{{ url('vendor/create') }}" class="btn btn-primary btn-xs" title="Agregar Ubicacion"><span class="glyphicon glyphicon-plus" aria-hidden="true"/></a></h1>
    <div class="table">
        <table class="table table-bordered table-striped table-hover">
            ...
            @foreach($vendor as $item)
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ url('/vendor/' . $item->id) }}" class="btn btn-success btn-xs" title="Ver Ubicacion"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"/></a>
