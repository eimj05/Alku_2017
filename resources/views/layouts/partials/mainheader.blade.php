...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-mini"><b>P</b>HE</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Alku</b></span>
    </a>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                               ...
                               <!--     <a  href="{{ url('/addperfilimg') }}">Cambiar imagen</a>-->
                                <p><!-- Logo -->              
                                    {{ Auth::user()->name }}
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ url('/cliente/cliente/profile/')}}" class="btn btn-default btn-flat">
                ...
                <li>
                    ...
                    <li>
                        <a href="#" data-toggle="control-sidebar"><i class="fa fa-birthday-cake"></i></a>
                    </li>-->
            </ul>
        </div>
    </nav>
