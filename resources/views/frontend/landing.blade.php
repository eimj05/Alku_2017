                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="box-image-text blog">
                                <div class="top">
                                    ...
                                    <div class="text">
                                        <p class="buttons">
                                            <a href="blog-post.html" class="btn btn-template-transparent-primary"><i class="fa fa-link"></i> Leer mas</a>
                                        </p>
                                    </div>
                                </div>
                                <div class="content">
                                    ...
                                    <p class="read-more"><a href="blog-post.html" class="btn btn-template-main">Continuar leyendo</a>
                                    </p>
                                </div>
                            </div>
                            <!-- /.box-image-text -->
