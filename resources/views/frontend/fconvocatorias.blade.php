    ...
    _________________________________________________________ -->
        ...
        <div id="heading-breadcrumbs">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h1>Portafolio de Convocatorias</h1>
                    </div>
                    <div class="col-md-5">
                        <ul class="breadcrumb">
                            <li><a href="/">Inicio</a>
                ...
                <section>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="lead">Aquí podrás encontrar las Convocatorias más importantes de las principales dependencias tanto Públicas como Privadas, puedes utilizar el filtro que se encuentra abajo para filtrar tus búsquedas de acuerdo a tu preferencia por categoría y seleccionar en detalles para ver la información completa de la Convocatoria.</p>
                        </div>
                    </div>
